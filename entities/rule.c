...
void init_rule(Rule *rule, const char rule_id_binary[]) {
    ...
    Rule res = {
            ...
            .all1_header_len = all1_header_length,
            .ack_header_len = ack_header_length,
            .max_window_nb = max_window_number,
            .max_fragment_nb = max_fragment_number,
            .regular_payload_len = regular_payload_length,
            .max_all1_payload_len = max_all1_payload_length,
